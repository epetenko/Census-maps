...
function ready(error, us, data){
    ...
    income[d.census2010] = +d.median_income_latest;
    moe[d.census2010] = +d.median_income_latest_moe;
    highmoe[d.census2010] = d.highmoe;
    townvsnj[d.census2010] = +d.townvsnj;
  ...
  $( ".waiting" ).remove();
      ...
      div.html("<h3>Hover over for more info</h3>")
       ...
       d3.select(this.parentNode.appendChild(this))
            ...
            div .html("<h2 class='" + highmoe[d.id] +"'>" + town_name[d.id] + "</h2><div id='infobox'><table class='muni_elex'><tr><th></th><th></th><th></th></tr><tr><td class='name clinton'>County:</td><td>"+county[d.id]+"</td><tr><td class='name clinton'>Median Income, 2015</td><td>" + highmoe[d.id] + "</td><td>" + " </td></tr><tr><td class='name clinton'>Percent difference from state average:</td><td>"+d3.round(townvsnj[d.id])+"%</table>")
   div
