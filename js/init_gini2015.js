...
queue()
    .defer(d3.json, "js/new_jersey_counties.json")
    .defer(d3.csv, "data/gini2015.csv")
...
var EqualColor = "#f7f7f7",
      ...
      var GiniMax = d3.max(data, function(d) { return parseInt(d.income); });
...
var GiniColor = d3.scale.quantize()
    .domain([0.35,0.55])
...
var keys = legend.selectAll('li.key')
    .data(GiniColor.range());

keys.enter().append('li')
    .attr('class', 'key')
    .style('border-top-color', String)
    .text(function(d) {
        var r = GiniColor.invertExtent(d);
  ...
  $( ".waiting" ).remove();
      ...
      collection = topojson.feature(us, us.objects.new_jersey_counties)
      ...
      div.html("<h3>Hover over for more info</h3>")
          ...
          feature.style("fill", function(d) { 
            ...
            console.log(gini[d.id])

            return GiniColor(gini[d.id])
       ...
       d3.select(this.parentNode.appendChild(this))
            ...
            div .html("<h2 class='" + gini[d.id] +"'>" + county[d.id] + "</h2><div id='infobox'><table class='muni_elex'><tr><th></th><th></th><th></th></tr><tr><td class='name clinton'>Gini Index</td><td>" + gini[d.id] + "</td><td>" + " </td></tr></table>")
   div
