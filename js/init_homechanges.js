...
queue()
    ...
    .defer(d3.csv, "data/housingvalues.csv")
...
function ready(error, us, data){
    ...
    homevalue[d.census2010] = +d.homevalue;
    moe[d.census2010] = +d.moe;
    highmoe[d.census2010] = d.highmoe;
    change[d.census2010] = +d.value_change;
    prevvalue[d.census2010] = +d.prevvalue;
...
var EqualColor = "#ffffff",
      ...
      var HomeMax = d3.max(data, function(d) { return parseInt(d.change); });
...
var HomeColor = d3.scale.quantize()
    .domain([-30,10])
...
var keys = legend.selectAll('li.key')
    .data(HomeColor.range());

keys.enter().append('li')
    .attr('class', 'key')
    .style('border-top-color', String)
    .text(function(d) {
        var r = HomeColor.invertExtent(d);
  ...
  $( ".waiting" ).remove();
      ...
      div.html("<h3>Hover over for more info</h3>")
       ...
       d3.select(this.parentNode.appendChild(this))
            ...
            div .html("<h2 class='" + change[d.id] +"'>" + town_name[d.id] + "</h2><h3>"+county[d.id]+"<h3><div id='infobox'><table class='muni_elex'><tr><th></th><th></th><th></th></tr><tr><td class='name clinton'>Median value, 2005-2009:</td><td>"+prevvalue[d.id]+"</tr><tr><td class='name clinton'>Median value, 2011-2015:</td><td>"+homevalue[d.id]+"</td><tr><td class='name clinton'>Home value change:</td><td>" +change[d.id].toLocaleString() + "</tr></table>")
   div
