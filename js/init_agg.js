...
queue()
    ...
    .defer(d3.csv, "data/county_agg.csv")
...
var EqualColor = "#f7f7f7",
      ...
      var AggMax = d3.max(data, function(d) { return parseInt(d.agg); });
...
var AggColor = d3.scale.quantize()
    .domain([15000, 50000])
  ...
  $( ".waiting" ).remove();
      ...
      div.html("<h3>Hover over for more info</h3>")
          ...
          feature.style("fill", function(d) { 
            ...
            console.log(agg[d.id])

            return AggColor(agg[d.id])
       ...
       d3.select(this.parentNode.appendChild(this))
            ...
            div .html("<h2 class='" + agg[d.id] +"'>" + county[d.id] + "</h2><div id='infobox'><table class='muni_elex'><tr><th></th><th></th><th></th></tr><tr><td class='name clinton'>Aggregate Income, 2015</td><td>" + agg[d.id] + "</td><td>" + " </td></tr></table>")
   div
