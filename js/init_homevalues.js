...
var EqualColor = "#f7f7f7",
      ...
      var HomeMax = d3.max(data, function(d) { return parseInt(d.homevalue); });
  ...
  $( ".waiting" ).remove();
      ...
      div.html("<h3>Hover over for more info</h3>")
          ...
          feature.style("fill", function(d) { 
            ...
            console.log(homevalue[d.id])

            return HomeColor(homevalue[d.id])
       ...
       d3.select(this.parentNode.appendChild(this))
            ...
            div .html("<h2 class='" + homevalue[d.id] +"'>" + town_name[d.id] + "</h2><div id='infobox'><table class='muni_elex'><tr><th></th><th></th><th></th></tr><tr><td class='name clinton'>Home value, 2011-2015</td><td>" +highmoe[d.id].toLocaleString() + "</tr><tr><td class='name clinton'>Percent difference from state:</td><td>"+d3.round(vsnj[d.id],2)+"%</td></tr></table>")
   div
